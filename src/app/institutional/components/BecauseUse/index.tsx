...
export function BecauseUse() {
    return (
        <section className='bg-yellow-400 w-full flex items-center justify-center py-20 flex-col'>
            ...
            <section className='flex flex-col lg:flex-row max-w-7xl w-11/12 gap-10 justify-between items-center'>
                <div className='w-2/3 flex items-center justify-center flex-col pr-0 lg:pr-14'>
                ...
                <div className='lg:w-1/3 w-2/3 flex flex-col items-center'>
